...
float Model::getExtrema()
{
  ...
  float maxExtrema = max(fabs(bounds.min.x), fabs(bounds.min.y));
  maxExtrema = max(maxExtrema, fabs(bounds.min.z));
  maxExtrema = max(maxExtrema, fabs(bounds.max.x));
  maxExtrema = max(maxExtrema, fabs(bounds.max.y));
  maxExtrema = max(maxExtrema, fabs(bounds.max.z));
